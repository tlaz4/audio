...
int main(int argc, char* argv[]){
        ...
        while(1){
            ...
            send(snew, joinBuffer.buffer, joinBuffer.curPointer * 2048, 0);
...
// stream the file in packets of 2048 bytes and output to stdout
void streamMedia(FILE *formatFile, long fileLen, list_t *clientList){
        int i;
        char c;
        char *streamBuffer;
        ...
        streamBuffer = (char *)malloc(2048 * sizeof(char));
        ...
        while(1){
                ...
                while (i < 2048){
                        ...
                        c = fgetc(formatFile);
                        if(feof(formatFile)){
                            //broadcastMedia(clientList, streamBuffer);
                            printf("done\n");
                            return;
                        }
                        i++;
                ...
                broadcastMedia(clientList, streamBuffer, 2048);
